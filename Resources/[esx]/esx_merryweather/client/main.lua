...
AddEventHandler('esx_customrob:startTimer', function()
	...
	Citizen.CreateThread(function()
		...
		GiveWeaponToPed(merryped1, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped2, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped3, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped4, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped5, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped6, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped7, GetHashKey('WEAPON_SMG'), 250, false, true)
		...
		GiveWeaponToPed(merryped8, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped9, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped10, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped11, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped12, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped13, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped14, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
		...
		GiveWeaponToPed(merryped15, GetHashKey('WEAPON_COMBATPISTOL'), 250, false, true)
