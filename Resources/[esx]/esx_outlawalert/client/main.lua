...
AddEventHandler('esx_outlawalert:outlawNotify', function(alert)
	if isPlayerWhitelisted then
		...
		exports['mythic_notify']:DoLongHudText('dispatch', alert)
--[[ 		exports['mythic_notify']:PersistentHudText('start', alert, 'error', alert)
		Citizen.Wait(5000)
		exports['mythic_notify']:PersistentHudText('end', alert) ]]
	end
end)
...
AddEventHandler('esx_outlawalert:DrugSaleInProgress', function(targetCoords)
	if isPlayerWhitelisted then
		local alpha = 250
		local drugBlip = AddBlipForRadius(targetCoords.x, targetCoords.y, targetCoords.z, Config.BlipMeleeRadius)

		SetBlipHighDetail(drugBlip, true)
		SetBlipColour(drugBlip, 17)
