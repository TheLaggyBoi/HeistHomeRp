...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 436.36,  y = -997.27, z = 25.76},
			{x = 431.25,  y = -997.23, z = 25.76},
			{x = 449.15,  y = -1015.5, z = 28.52},
			{x = 1873.05,  y = 3689.10, z = 33.59}
		}
	}
}
...
Config.PoliceCarMarkerColor = { r = 0, g = 0, b = 0, a = 100 } 		-- rgba color of the marker
...
Config.BoatDraw3DText = "Press [E] for Police Boat Garage~s~"		-- set your desired text here

-- Police Extra Garage Marker Settings:
Config.PoliceExtraMarker = 27 												-- marker type
Config.PoliceExtraMarkerColor = { r = 0, g = 0, b = 0, a = 100 } 		-- rgba color of the marker
...
Config.PoliceVehicles = {
	--{ model = 'policeb', label = 'LSPD Hellcat (SGT or Higher)', price = 0 },
	{ model = 'r1200rtp', label = 'LSPD Police Bike', price = 0 },
	{ model = 'pdimpala', label = 'LSPD Impala', price = 0 },
	{ model = 'pdcharger', label = 'LSPD Charger', price = 0 },
	{ model = 'chgr', label = 'Unmarked Charger', price = 0 },
	{ model = 'pol718', label = 'LSPD Speed Enforcer Porsche', price = 0 },
	{ model = '2015polstang', label = 'LSPD Speed Enforcer Mustang', price = 0 },
	{ model = 'pdfpiu', label = 'LSPD Interceptor SUV', price = 0 },
	{ model = 'exp', label = 'LSPD Interceptor Explorer SUV', price = 0 },
	{ model = 'srt8police', label = 'LSPD Jeep SUV', price = 0 },
	{ model = '20camaro', label = 'LSPD Chief Camaro', price = 0 },
	{ model = 'riot', label = 'LSPD Riot Truck', price = 0 },
	{ model = 'pbus', label = 'Large prison Truck', price = 0 }
}
...
Config.CarOutFromPolGar = "You took out a Vehicle from Police Garage!"
Config.HeliOutFromPolGar = "You took out a Helicopter from Police Heli Garage!"
Config.BoatOutFromPolGar = "You took out a Boat from Police Boat Garage!"
