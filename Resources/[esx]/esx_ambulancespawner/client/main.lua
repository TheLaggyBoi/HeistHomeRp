...
-- Entered Marker
AddEventHandler('esx_vehiclespawner2:hasEnteredMarker', function(zone)
...
-- Exited Marker
AddEventHandler('esx_vehiclespawner2:hasExitedMarker', function()
	ESX.UI.Menu.CloseAll()
	CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerEvent('esx_vehiclespawner2:hasEnteredMarker', currentZone)
		end

		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('esx_vehiclespawner2:hasExitedMarker', LastZone)
		end
