	...
	function(from, target, type, itemName, itemCount)
		...
		if type == "item_standard" then
			...
			if itemCount > 0 and sourceItem.count >= itemCount then
				...
				--if targetItem.weight ~= -1 and (targetItem.count + itemCount) > targetItem.weight then
					...
					--TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('item_removed' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })

					targetXPlayer.addInventoryItem(itemName, itemCount)
					TriggerClientEvent('b1g_notify:client:Notify', targetXPlayer, { type = 'true', text = _U('item_added') .. itemName})
					--TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'inform', text = _U('item_added' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
				else
					TriggerClientEvent('b1g_notify:client:Notify', targetXPlayer, { type = 'false', text = _U('player_inv_no_space') .. itemName})
					--TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'error', text = _U('player_inv_no_space' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
					TriggerClientEvent('b1g_notify:client:Notify', sourceXPlayer, { type = 'false', text = _U('player_inv_no_space') .. itemName})
					--TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'error', text = _U('player_inv_no_space' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
				end
			end
		elseif type == "item_money" then
			if itemCount > 0 and sourceXPlayer.getMoney() >= itemCount then
				...
				--TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('money_removed' .. itemCount) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
				targetXPlayer.addMoney(itemCount)
				TriggerClientEvent('b1g_notify:client:Notify', targetXPlayer, { type = 'true', text = _U('money_added') .. itemCount})
				--TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'success', text = _U('money_added' .. itemCount) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
			end
		elseif type == "item_account" then
			if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
				...
				--TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('money_removed' .. itemCount .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
				targetXPlayer.addAccountMoney(itemName, itemCount)
				TriggerClientEvent('b1g_notify:client:Notify', targetXPlayer, { type = 'true', text = _U('money_added') .. itemCount .. itemName})
				--TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'success', text = _U('money_added' .. itemCount .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
			end
		elseif type == "item_weapon" then
			if not targetXPlayer.hasWeapon(itemName) then
				sourceXPlayer.removeWeapon(itemName)
				TriggerClientEvent('b1g_notify:client:Notify', sourceXPlayer, { type = 'true', text = _U('weapon_removed') .. itemName})
				--TriggerClientEvent('mythic_notify:client:SendAlert', sourceXPlayer, { type = 'inform', text = _U('weapon_removed' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
				targetXPlayer.addWeapon(itemName, itemCount)
				TriggerClientEvent('b1g_notify:client:Notify', targetXPlayer, { type = 'true', text = _U('weapon_added') .. itemName})
				--TriggerClientEvent('mythic_notify:client:SendAlert', targetXPlayer, { type = 'success', text = _U('weapon_added' .. itemName) , style = { ['background-color'] = '#ffffff', ['color'] = '#000000' } })
			end
		end
	end
)
