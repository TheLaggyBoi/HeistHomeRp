...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	...
	local isunderBoss = xPlayer.job.grade_name == 'deputy'

	if isBoss or isunderBoss then
...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'deputy' then
		return true
	else
