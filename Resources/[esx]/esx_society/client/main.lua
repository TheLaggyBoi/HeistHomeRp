...
function RefreshBussHUD()
	...
	if ESX.PlayerData.job.grade_name == 'boss' and ESX.PlayerData.job.grade_name == 'deputy' then
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' and ESX.PlayerData.job.grade_name == 'deputy' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
