...
Config.EMSDatabaseName = 'ambulance'	-- set the exact name from your jobs database for EMS

--EMS Car Garage:
Config.CarZones = {
	EMSCarGarage = {
		Pos = {
			{x = 342.22,  y = -558.65, z = 28.74},
			{x = 326.72,  y = -554.74, z = 28.74}
		}
	}
}
...
Config.BoatDraw3DText = "Press [E] for EMS Boat Garage~s~"		-- set your desired text here

-- EMS Extra Garage Marker Settings:
Config.EMSExtraMarker = 27 												-- marker type
Config.EMSExtraMarkerColor = { r = 0, g = 0, b = 0, a = 100 } 		-- rgba color of the marker
Config.EMSExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~EMS Extra Menu~s~"		-- set your desired text here

-- -- EMS Cars:
Config.EMSVehicles = {
	{ model = 'emsroamer', label = 'Ambulance Suv', price = 0 },
	{ model = 'ambucara', label = 'Speedo Ambulance', price = 0 },
	{ model = 'dodgesamu', label = 'Charger Ambulance', price = 0 },
	{ model = 'qrv', label = 'Explorer Suv', price = 0 },
	{ model = 'tundra', label = 'Toyota Ambulance', price = 0 },
	{ model = 'ambulance', label = 'Ambulance', price = 0 }
}

-- EMS Helicopters:
Config.EMSHelicopters = {
	{ model = 'polmav', label = 'EMS Maverick', livery = 2, price = 0 }
}
...
Config.TitleEMSGarage = "EMS Garage"
Config.TitleEMSExtra = "Extra"
Config.TitleEMSLivery = "Livery"
Config.TitleColorType = "Color Type"
Config.TitleValues = "Value"

-- ESX.ShowNotifications:
Config.VehicleParked = "Vehicle was parked!"
Config.NoVehicleNearby = "No Vehicle nearby!"
Config.CarOutFromPolGar = "You took out a Vehicle from EMS Garage!"
Config.HeliOutFromPolGar = "You took out a Helicopter from EMS Heli Garage!"
Config.BoatOutFromPolGar = "You took out a Boat from EMS Boat Garage!"
Config.VehRepNotify = "Your vehicle is being repaired, please wait!"
Config.VehRepDoneNotify = "Your vehicle has been repaired!"
Config.VehCleanNotify = "Your vehicle is being cleaned, please wait!"
Config.VehCleanDoneNotify = "Your vehicle has been cleaned!"
...
-- EMS Extra Menu Positions:
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = 317.57,  y = -548.07, z = 28.74}
		}
	}
}
