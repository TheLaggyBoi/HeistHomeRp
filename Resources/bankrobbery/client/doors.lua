...
RegisterNetEvent('lh-bankrobbery:client:ClearTimeoutDoors')
AddEventHandler('lh-bankrobbery:client:ClearTimeoutDoors', function()
    TriggerServerEvent('esx_doorlock:updateState', 85, true)
