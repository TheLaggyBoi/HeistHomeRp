...
-- Search Rewards:
Config.SearchItems = {
	[1] = {item = "joint", name = "Joint", min = 1, max = 4, chance = 67},
	[2] = {item = "bread", name = "Bread", min = 1, max = 3, chance = 20},
	[3] = {item = "water", name = "Water", min = 1, max = 4, chance = 54},
	[4] = {item = "water", name = "Water", min = 1, max = 3, chance = 85},
