...
Config.dfs_noambience = {
    BannedCarModels = {
        ...
        { modelname = "POLICEB"    , BannedFromSpawning = true,  RemoveUntouched = true   },
        { modelname = "POLICE3"    , BannedFromSpawning = true,  RemoveUntouched = true   },
    ...
    DefaultClassBoosts = {
        ...
        [18] =  {   className = "emergency"     ,   torque = 1.8  ,  initialDriveForce =   0.0  ,  fDriveInertia = 0.0, fClutchChangeRateScaleUpShift = 0.0, fClutchChangeRateScaleDownShift = 0.0, fInitialDriveMaxFlatVel = 0.0, fBrakeForce = 0.0, fHandBrakeForce = 0.0, fTractionCurveMax = 0.0, fTractionCurveLateral = 0.0, fTractionCurveMin = 0.0},
