...
ESX.RegisterServerCallback("disc-drugsalescoke:sellDrug", function(source, cb)
...
ESX.RegisterServerCallback('disc-drugsalescoke:hasDrugs', function(source, cb)
    local player = ESX.GetPlayerFromId(source)
    local item, hasItem = DoPlayerHaveItems(player)
    cb(hasItem)
end)

ESX.RegisterServerCallback('disc-drugsalescoke:getOnlinePolice', function(source, cb)
