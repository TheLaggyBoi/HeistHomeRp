...
Config.ArmorStaggerChance = 30 -- Note : Small caliber weapons are this % halved
...
Config.BedList = {
	...
	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 324.26, y = -582.8, z = 44.2},--pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 319.41, y = -581.04, z = 44.2},--pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 313.93, y = -579.04, z = 44.2},---pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 309.34, y = -577.41, z = 44.2},---pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = 80.0,
		objCoords  = {x = 307.34, y = -581.75, z = 44.2},---pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = 80.0,
		objCoords  = {x = 311.06, y = -582.96, z = 44.2}, --pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 314.47, y = -584.2, z = 44.2}, --pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = -20.0,
		objCoords  = {x = 317.47, y = -585.37, z = 44.2}, --pillbox blue bed
	},

	{
		text = 'Press ~ g ~ E ~ w ~ to lie on the bed',
		heading = 160.0,
		objCoords  = {x = 322.62, y = -587.17, z = 44.2}, --pillbox blue bed
	}
}
