  ...
  while true do
	...
	if IsControlPressed(0,  Keys['L']) then
	  if PlayerData.gang.name ~= 'none' then
        ...
        AddTextComponentString('You are of that rank: '..PlayerData.gang.gang_grade_label..' in this community '..PlayerData.gang.gang_label)
        DisplayHelpTextFromStringLabel(0, 0, 1, -1)
	  else
        SetTextComponentFormat('STRING')
        AddTextComponentString('You do not belong to any community.')
		DisplayHelpTextFromStringLabel(0, 0, 1, -1)
	  end
	end
  end
