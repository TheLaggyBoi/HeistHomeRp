...
onNet("server-request-update", async (player) => {
    let src = source
    let playerinvname = player
    let string = `SELECT count(item_id) as amount, id, item_id, name, information, slot, quality, dropped FROM user_inventory2 WHERE name ='${player}' group by item_id`;// slot
    exports.ghmattimysql.execute(string, {}, function(inventory) {
...
onNet("server-request-update-src", async (player,src) => {
    ...
    let string = `SELECT count(item_id) as amount, id, item_id, name, information, slot, quality, dropped FROM user_inventory2 WHERE name = 'ply=${player}' group by item_id`; // slot
    exports.ghmattimysql.execute(string, {}, function(inventory) {
        ...
        switch(itemid.toLowerCase()) {
          ...
          if(itemdata == itemdata.fake){
              returnInfo = JSON.stringify({
                  ...
                  let string = `SELECT firstname,lastname,sex,dateofbirth FROM characters WHERE identifier = '${player}'`;
...
onNet("server-inventory-stack", async (player, data, coords) => {
    ...
    let itemidsent = data[7]
     ...
     if (purchase) {
         ...
         if (PlayerStore) {
             let string = `SELECT item_id FROM user_inventory2 WHERE slot='${originSlot}' and name='${originInventory}'`;
         ...
         let string = `SELECT item_id, creationDate, quality FROM user_inventory2 WHERE slot='${originSlot}' and name='${originInventory}'`;
  
         exports.ghmattimysql.execute(string,{}, function(result) {

             if (targetName.indexOf("Drop") > -1 || targetName.indexOf("hidden") > -1) {
 
                db(`UPDATE user_inventory2 SET slot='${targetslot}', name='${targetName}', dropped='0' WHERE slot='${originSlot}' and name='${originInventory}' and creationDate='${result[0].creationDate}' and item_id='${result[0].item_id}' LIMIT ${moveAmount}`);
...
function PoliceArmory() {
    var shopItems = [
        ...
        { item_id: "3219281620", id: 0, name: "Shop", information: "{}", slot: 3, amount: 1 },
        { item_id: "-86904375", id: 0, name: "Shop", information: "{}", slot: 4, amount: 1 },
        { item_id: "-2084633992", id: 0, name: "Shop", information: "{}", slot: 5, amount: 1 },
        { item_id: "911657153", id: 0, name: "Shop", information: "{}", slot: 6, amount: 1 },
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 7, amount: 1 },
        { item_id: "watch", id: 0, name: "Shop", information: "{}", slot: 8, amount: 1 },
        { item_id: "IFAK", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
        { item_id: "advrepairkit", id: 0, name: "Shop", information: "{}", slot: 10, amount: 5 },
        { item_id: "repairkit", id: 0, name: "Shop", information: "{}", slot: 11, amount: 5 },
...
function Blackmarket() {
    var shopItems = [
        ...
        { item_id: "911657153", id: 0, name: "craft", information: "{}", slot: 6, amount: 1 },
        {item_id: "453432689", id: 0, name: "craft", information: "{}", slot: 7, amount: 1 },
        { item_id: "324215364", id: 0, name: "craft", information: "{}", slot: 8, amount: 1 },
        { item_id: "-619010992", id: 0, name: "craft", information: "{}", slot: 9, amount: 1 },
        { item_id: "extended_ap", id: 0, name: "craft", information: "{}", slot: 10, amount: 1 },
        { item_id: "extended_micro", id: 0, name: "craft", information: "{}", slot: 11, amount: 1 },
        { item_id: "silencer_s", id: 0, name: "craft", information: "{}", slot: 12, amount: 1 },
        { item_id: "extended_tec9", id: 0, name: "craft", information: "{}", slot: 13, amount: 1 },
...
function Mechanic() {
    var shopItems = [
        ...
        { item_id: "tuner", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
        { item_id: "repairkit", id: 0, name: "craft", information: "{}", slot: 4, amount: 5 },
        { item_id: "advrepairkit", id: 0, name: "craft", information: "{}", slot: 5, amount: 5 },
    ];
    return JSON.stringify(shopItems);
}
...
function ConvenienceStore() {
    var shopItems = [
        ...
        { item_id: "bandage", id: 0, name: "Shop", information: "{}", slot: 8, amount: 5 },
        ...
        { item_id: "idcard", id: 0, name: "Shop", information: "{}", slot: 13, amount: 1 },
    ];
    return JSON.stringify(shopItems);
}
...
function HardwareStore() {
    var shopItems = [
        ...
        { item_id: "advrepairkit", id: 0, name: "Shop", information: "{}", slot: 5, amount: 5 },
        { item_id: "radio", id: 0, name: "Shop", information: "{}", slot: 6, amount: 5 },
        { item_id: "watch", id: 0, name: "Shop", information: "{}", slot: 7, amount: 5 },
        { item_id: "Suitcase", id: 0, name: "Shop", information: "{}", slot: 8, amount: 5 },
        { item_id: "Boombox", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
        { item_id: "Box", id: 0, name: "Shop", information: "{}", slot: 10, amount: 5 },
        { item_id: "DuffelBag", id: 0, name: "Shop", information: "{}", slot: 11, amount: 5 },
        { item_id: "MedicalBag", id: 0, name: "Shop", information: "{}", slot: 12, amount: 5 },
        { item_id: "lockpick", id: 0, name: "Shop", information: "{}", slot: 13, amount: 5 },
...
function GunStore() {
    var shopItems = [
        ...
        { item_id: "3218215474", id: 0, name: "Shop", information: "{}", slot: 9, amount: 1 },
    ];
    return JSON.stringify(shopItems);
};
