...
Config.HandcuffTimer              = 7 * 60000 -- 10 mins
...
Config.AuthorizedWeapons = {
	recruit = {
		...
		{weapon = 'disc_ammo_pistol', price = 0},
		{weapon = 'disc_ammo_pistol_large', price = 0}
	},
	...
	officer = {
		...
		{weapon = 'disc_ammo_pistol', price = 0},
		{weapon = 'disc_ammo_pistol_large', price = 0},		
		{weapon = 'disc_ammo_shotgun', price = 0},
		{weapon = 'disc_ammo_shotgun_large', price = 0}
	},
	...
	boss = {
		...
		{weapon = 'WEAPON_SMG', components = {0, 0, 0, 0, 0, nil}, price = 0},
		{weapon = 'WEAPON_PUMPSHOTGUN', components = {0, 0, nil}, price = 0},
		{weapon = 'WEAPON_HEAVYSNIPER', components = {0, 0, nil}, price = 0},
		{weapon = 'WEAPON_NIGHTSTICK', price = 0},
		{weapon = 'WEAPON_STUNGUN', price = 0},
		{weapon = 'WEAPON_FLASHLIGHT', price = 0}
	}
...
Config.AuthorizedVehicles = {
	car = {
		recruit = {
			{model = 'police', price = 20}
		},

		officer = {
			{model = 'police3', price = 20},
			{model = 'police2', price = 20}
		},

		sergeant = {
			{model = 'PBus', price = 185},
			{model = 'policeb', price = 305}
		},

		lieutenant = {
			{model = 'riot', price = 700},
			{model = 'fbi2', price = 600}
		},

		boss = {
			{model = 'sheriff2', price = 600},
			{model = 'fbi', price = 200},
			{model = 'Nero2', price = 600}
		}
	},
	...
	helicopter = {
		...
		lieutenant = {
			{model = 'polmav', props = {modLivery = 0}, price = 200}
		},
