...
AddEventHandler('esx_policejob:sc', function(target, playerheading, playerCoords,  playerlocation)
    _source = source
    TriggerClientEvent('esx_policejob:loose', target, playerheading, playerCoords, playerlocation)
    TriggerClientEvent('esx_policejob:douncuffing', _source)
end)

RegisterServerEvent('esx_policejob:requesthard')
AddEventHandler('esx_policejob:requesthard', function(target, playerheading, playerCoords,  playerlocation)
    _source = source
    TriggerClientEvent('esx_policejob:getarrestedhard', target, playerheading, playerCoords, playerlocation)
    TriggerClientEvent('esx_policejob:doarrested', _source)
end)
