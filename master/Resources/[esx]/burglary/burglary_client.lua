...
local burglaryPlaces = {
    ...
    --[[["Robban 2"] = {
      pos = { x = 1221.46, y = -669.87, z = 63.49, h = 200.24 },  -- door coords
      locked = true,
      inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 },  -- Inside coords
      animPos = { x = 1221.46, y = -669.87, z = 63.49, h = 200.24 },   -- The animation position
  },]]

      
    ["Groove 1"] = {
        pos = { x = 85.56, y = -1959.78, z = 21.12, h = 215.95 },  -- door coords
        locked = true,
        inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
        animPos = { x = 85.98, y = -1959.78, z = 21.12, h = 215.95 },   -- The animation position
    },

    ["Groove 2"] = {
      pos = { x = 118.4, y = -1921.07, z = 21.32, h = 238.42 },  -- door coords
      locked = true,
      inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
      animPos = { x = 118.4, y = -1921.07, z = 21.32, h = 238.42 },   -- The animation position
  },
  
  ["Groove 3"] = {
    pos = { x = 126.77, y = -1930.07, z = 21.38, h = 211.36 },  -- door coords
    locked = true,
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 126.77, y = -1930.07, z = 21.38, h = 211.36 },   -- The animation position
},
}

local burglaryInside = {
    ["Ring"] = { x = 342.23, y = -1003.29, z = -99.0, item = 'ring', amount = math.random(2,4)},
    ["Speaker"]  = {x = 338.14, y = -997.69, z = -99.2, item = 'speaker', amount = math.random(1,2)},
    ["Laptop"] = { x = 350.91 , y = -999.26 , z = -99.2, item = 'laptop', amount = 1},
    ["ElectronicKit"] = { x = 349.19, y = -994.83, z = -99.2, item = 'electronickit', amount = math.random(0,1)},
    ["Camera"]  = { x = 345.3, y = -995.76, z = -99.2, item = 'camera', amount = math.random(1,2)},
    ["Rolex"] = { x = 346.14, y = -1001.55, z = -99.2, item = 'rolex', amount = math.random(1,3)},

}

local closets = {
    ["Robban's Closet"] = { x = 351.24, y = -993.53, z = -99.2, items = {'shirt', 'pants', 'hat', 'shoes'}, shirtAmount = 0, pantsAmount = 0, hatAmount = 0, shoesAmount = 0},
}
