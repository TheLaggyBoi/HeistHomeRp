...
-- Store Vehicles
--[[ ESX.RegisterServerCallback('esx_advancedgarage:storeVehicle', function (source, cb, vehicleProps , damage)
	local ownedCars = {}
...
--[[ ESX.RegisterServerCallback('tiger_cardealer:GetOwnedVehByPlate',function(source, cb, plate)	
	local ownedCars = {}
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_advancedgarage:getVehicledamage', function(source, cb, plate)
