...
RegisterNetEvent("conde_inventory:openGloveboxInventory")
AddEventHandler(
    "conde_inventory:openGloveboxInventory",
...
RegisterNetEvent("conde_inventory:refreshGloveboxInventory")
AddEventHandler(
    "conde_inventory:refreshGloveboxInventory",
    function(data, blackMoney, cashMoney, inventory, weapons)
        setGloveboxInventoryData(data, blackMoney, cashMoney, inventory, weapons)
    end
)
