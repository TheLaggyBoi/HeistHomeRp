...
AddEventHandler('conde_inventory:disableOpen', function()
    closeInventory()
    canOpenTrunkInventory = false
end)
AddEventHandler("conde_inventory:enableOpen", function()
    canOpenTrunkInventory = true
end)

RegisterNetEvent("conde_inventory:openTrunkInventory")
AddEventHandler("conde_inventory:openTrunkInventory",function(data, blackMoney, cashMoney, inventory, weapons)
	setTrunkInventoryData(data, blackMoney, cashMoney, inventory, weapons)
	openTrunkInventory()
end)

RegisterNetEvent("conde_inventory:refreshTrunkInventory")
AddEventHandler("conde_inventory:refreshTrunkInventory",function(data, blackMoney, cashMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, cashMoney, inventory, weapons)
end)
