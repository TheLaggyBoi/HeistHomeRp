...
Citizen.CreateThread(function()
	...
	while true do
		...
		--local closestSafe = GetClosestObjectOfType(coords, 5.0, -284254006, false, false, false)
			...
			if dstCheck <= 2.5 then 
				...
				if display then
					...
					if dstCheck <= 1.0 then
						local displayText = isCracking and "Cracking..." or "~INPUT_CONTEXT~ To start cracking."
