...
StartCrackingSafe = function(safeEntity)
	...
	currentSafeCorrectPosition = math.random(1, 90)
	print(currentSafeCorrectPosition)
			...
			if IsControlJustPressed(0, 22) then
				if dialRotation == currentSafeCorrectPosition then
					...
					if #safeLocks == 1 then
						...
						TriggerServerEvent("esx_phone:send", "police", "GPS Someone Has Cracked A Store Vault!", true, { ["x"] = x, ["y"] = y, ["z"] = z })
					end
