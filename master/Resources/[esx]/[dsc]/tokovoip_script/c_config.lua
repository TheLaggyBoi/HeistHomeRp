TokoVoipConfig = {
	...
	radioClickMaxChannel = 300, -- Set the max amount of radio channels that will have local radio clicks enabled
	...
	plugin_data = {
		...
		TSChannel = "In-Game",
		TSPassword = "imadmin", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "Go to https://sites.google.com/view/heisthome", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "citizen", -- If set, this name will be used as the user's teamspeak display name
