...
function startIntro() {
    var audio = new Audio("audio/casa_papel.mp3");
...
function showLogo(status) {
    switch (status) {
        case true:
            ...
            $("#logo").css("background-image", "url('img/logos/yourname1.png')");
            break;
        case false:
