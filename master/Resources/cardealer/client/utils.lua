...
RegisterNetEvent('cardealer:ShowNotifyESX')
AddEventHandler('cardealer:ShowNotifyESX', function(msg)
	ShowNotifyESX(msg)
end)
...
function ProduceNumberPlate()
	...
	while true do
		...
		ESX.TriggerServerCallback('cardealer:PlateInUse', function (PlateInUse)
	...
	if option == "repay" then
		if plate ~= nil or not plate == '' then
			if amount ~= nil or amount >= 1 then
				ESX.TriggerServerCallback('cardealer:GetOwnedVehByPlate', function(vehPlate, vehPrice, vehHash, vehFinance, vehRepaytime)
