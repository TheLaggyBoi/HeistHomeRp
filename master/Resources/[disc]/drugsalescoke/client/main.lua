...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if dist <= 2 then
            ...
            local zone = GetNameOfZone(295, 179, 104.22)
            ...
            if IsControlJustReleased(0, 38) and cs and cst then
                ESX.TriggerServerCallback('disc-drugsalescoke:getOnlinePolice',
                        function(online)
...
Citizen.CreateThread(function()
    ...
    while true do
        ESX.TriggerServerCallback('disc-drugsalescoke:hasDrugs', function(hD)
            if hasDrugs ~= hD then
                if hD then
